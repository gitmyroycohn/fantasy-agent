...
[ PINS & PILLS  |  H2H Categories ]
  Matchup : Week 13 vs Natural Born Closers: 9-1-2
  Target  : HR, SB, S
  Stream SP: Andrew Alvarez (WAS) [2-START]  ERA ?  K/9 ?
  ** Submit adds before Monday scoring period lock. **
  Also    : Slade Cecconi, Robert Gasser
  Top Add  : Blaze Alexander (BAL) [3B]  helps HR
  Also     : Willy Adames (SS), Luisangel Acuna (2B)
...
[ CASEY STENGEL  |  NL-Only Roto ]
  ...
  DROP     : Andrew Vaughn
  Standings: Period 13: 50 roto pts - winning 6 cats, losing 4
  Weakest  : HR, WHIP, SB, S
...
=== Pins and Pills (baseball) ===
  Roster: 33 players
      ...
      2B  Luke Keaschall (MIN)
      3B  Sal Stewart (CIN)
      SS  JJ Wetherholt (STL)
    ... and 28 more
  Stats enriched: 28/33 roster players
  Lineup: 18/33 starting
  Free agents visible: 8122

  FP projections (SP wire): 18/100 matched
  Schedule (3wk): Wk1:26x2 | Wk2:0x2 | Wk3:0x2
  FP projections (all wire): 31/200 matched
  Savant batter xStats: 566 players
  Savant EV/Barrel: 383 players
  Savant pitcher xStats: 696 players
  ...
  Matchup: Week 13 vs Natural Born Closers: 9-1-2
  Priority categories (losing, easiest first): HR, SB, S
  Streaming SP (Submit adds before Monday scoring period lock.):
    + Andrew Alvarez (WAS) [2-START]  [day 3]  score=8.77  *** 2-START WEEK *** | ERA 3.49, K/9 9.85, WHIP 1.45 | helps: S
    + Slade Cecconi (CLE) [2-START]  [day 2]  score=4.0  *** 2-START WEEK *** | helps: S
    + Robert Gasser (MIL) [2-START]  [day 2]  score=4.0  *** 2-START WEEK *** | helps: S
    + Ryan Gusto (MIA) [2-START]  [NEW]  score=4.0  *** 2-START WEEK *** | helps: S
    + Grant Holmes (ATL) [2-START]  [day 2]  score=4.0  *** 2-START WEEK *** | helps: S
  Waiver adds (5 suggestions) (top 3 shown -- 2 more suppressed):
    + Blaze Alexander (BAL) [3B]  [day 3]  helps: HR  [Brl%=6.5 | xwOBA=0.357]
    + Willy Adames (SF) [SS]  [day 3]  helps: SB  [Brl%=9.8 | xwOBA=0.295]
    + Luisangel Acuna (CHW) [2B]  [day 3]  helps: SB

  --- Drop Candidates ---
  CUT (1) -- below replacement level:
    DROP Justin Crawford (PHI) [CF] [bench]  [day 3]
         Below replacement: HR 2, R 20, RBI 15, OPS 0.621

  --- Closer Monkey News ---
  [LEDGER] Closer Monkey’s Leverage Ledger | 6.19.2026
  ...
  SELL HIGH (9) -- outpacing projections:
    ~ Raisel Iglesias (ATL) [RP] [strong]
      ERA 1.16 vs proj 3.49
    ~ Sal Stewart (CIN) [1B] [strong]
      SB 11 vs proj 7
    ~ Bryan Baker (TB) [RP] [strong]
      ERA 1.91 vs proj 3.67; WHIP 0.95 vs proj 1.26
    ~ Nick Martinez (TB) [SP] [strong]
      ERA 2.60 vs proj 4.41
  BUY LOW (13) -- underperforming projections:
    ~ Christian Walker (HOU) [1B] [strong]
      SB 0 vs proj 1
    ~ Bo Bichette (NYM) [SS] [strong]
      SB 1 vs proj 3; HR 8 vs proj 11 [xBA 0.286 > BA -- unlucky, strong buy]
    ~ William Contreras (MIL) [C] [strong]
      SB 1 vs proj 3; HR 6 vs proj 11
    ~ Luke Keaschall (MIN) [2B] [strong]
      HR 2 vs proj 5
  ...
  --- Daily Lineup (Fri Jun 19, 28 MLB teams playing) ---
  ...
  SPs NOT starting today (9):
    ...
    [     ACTIVE - bench!] Jose Soriano (LAA)  LAA playing but not listed as probable starter
  ...
  Batters with off days - bench these (7):
    ...
    [     already benched] Justin Crawford (PHI) [CF]
  Batters with games today: 13
...
=== The Casey Stengel Amazin Experience (baseball) ===
  ...
  Savant xStats (roster): 26/28 matched
  Format: NL-Only Rotisserie

  ⚠  CHURN GUARD: 6 moves recommended -- showing top 3 per section. Prioritize ruthlessly; avoid making all moves at once.
  Waiver adds (5 suggestions) (top 3 shown -- 2 more suppressed):
    + Jose Alvarado (PHI) [RP]  [day 3]  helps: K, SV
    + Andrew Alvarez (WAS) [SP]  [day 3]  helps: K, ERA  [xERA=4.67]
    + Tyler Alexander (PHI) [RP]  [day 3]  helps: K, SV  [xERA=3.31]

  --- Drop Candidates ---
  CUT (1) -- below replacement level:
    DROP Andrew Vaughn (MIL) [1B] [active]  [day 3]
         Below replacement: HR 2, R 15, RBI 19, SB 0
  Standings: Period 13: 50 roto pts - winning 6 cats, losing 4
  Weakest categories: HR, WHIP, SB, S
  ...
  SELL HIGH (13) -- outpacing projections:
    ...
    ~ Max Muncy (LAD) [3B] [strong]
      HR 16 vs proj 7; R 47 vs proj 26
    ~ Casey Schmitt (SF) [2B] [strong]
      SB 7 vs proj 4; HR 15 vs proj 11
    ~ Raisel Iglesias (ATL) [RP] [strong]
      ERA 1.16 vs proj 3.49
  BUY LOW (9) -- underperforming projections:
    ~ Ketel Marte (ARI) [2B] [strong]
      SB 0 vs proj 2; HR 11 vs proj 14 [xBA 0.301 > BA -- unlucky, strong buy]
    ~ Will Smith (LAD) [C] [strong]
      SB 0 vs proj 1; HR 6 vs proj 8 [xBA 0.275 > BA -- unlucky, strong buy]
    ~ Andrew Vaughn (MIL) [1B] [strong]
      HR 2 vs proj 10; R 15 vs proj 32; RBI 19 vs proj 39
  ...
  Batters with no game today (6) [no bench -- FYI only]:
